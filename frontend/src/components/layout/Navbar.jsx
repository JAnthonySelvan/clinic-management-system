        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-7">
            ...
            >
              ...
              <div
                className={`absolute -left-32 mt-3 w-[720px] origin-top-left overflow-hidden rounded-3xl bg-white p-5 shadow-2xl ring-1 ring-black/5 transition-all duration-200 ease-out ${
                  servicesMenuOpen
                    ? "translate-y-0 scale-100 opacity-100"
                    : "pointer-events-none -translate-y-2 scale-95 opacity-0"
                }`}
              >
                <div className="flex gap-5">
                  {/* Left: 8 Specialization Services Grid */}
                  <div className="w-[65%]">
            ...
            >
              ...
              {/* Dropdown Card */}
              <div
                className={`absolute right-0 mt-3 w-64 origin-top-right overflow-hidden rounded-2xl bg-white p-2.5 shadow-2xl ring-1 ring-black/5 transition-all duration-200 ease-out ${
                  appointmentMenuOpen
                    ? "translate-y-0 scale-100 opacity-100"
                    : "pointer-events-none -translate-y-2 scale-95 opacity-0"
                }`}
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Link
              to="/appointment/book"
              className="flex items-center gap-2 rounded-2xl bg-[#253237] px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white shadow-md transition-all duration-300 hover:bg-[#1c272a] hover:shadow-lg hover:scale-[1.02]"
            >
              <span>Book Now</span>
            ...
            <div className="relative" ref={loginMenuRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-2xl border border-gray-200 bg-[#F8FBFC] px-4 py-2 text-xs font-bold uppercase tracking-wider text-[#253237] shadow-xs transition-all duration-300 hover:bg-white hover:shadow-sm"
              >
              ...
              <div
                className={`absolute right-0 mt-2 w-48 origin-top-right overflow-hidden rounded-2xl bg-white p-2 shadow-xl ring-1 ring-black/5 transition-all duration-200 ease-out ${
                  loginMenuOpen
                    ? "translate-y-0 scale-100 opacity-100"
                    : "pointer-events-none -translate-y-2 scale-95 opacity-0"
                }`}
