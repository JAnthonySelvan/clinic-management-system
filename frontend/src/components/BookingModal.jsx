      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto font-outfit">
          ...
          >
            ...
            />
            {/* Overlay Scrim Across Full Modal */}
            <div className="absolute inset-0 bg-black/40" />

            {/* Header Banner */}
            <div className="relative z-10 overflow-hidden p-6 sm:p-7 text-white shrink-0 border-b border-white/15">
              <button
                type="button"
                onClick={onClose}
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-5">
                ...
                <div className="text-center sm:text-left">
                  <div className="inline-flex items-center space-x-1.5 rounded-full bg-[#0a161c] px-3.5 py-1 text-xs font-semibold text-[#E0FBFC] border border-[#253237] shadow-md mb-2">
                  ...
                  <h2 className="font-serif-display text-2xl sm:text-3xl font-bold text-[#0a161c] leading-snug drop-shadow-xs">
                  ...
                  <p className="text-xs sm:text-sm text-[#253237] font-semibold font-jakarta mt-1">
                ...
                {availableDoctors && availableDoctors.length > 0 && (
                  <div className="rounded-2xl bg-white/5 p-4 border border-teal-400/20 backdrop-blur-md">
                    ...
                    <select
                      ...
                      className="w-full border-0 border-b-2 border-white/30 bg-black/30 backdrop-blur-md px-3 py-3 text-sm font-medium text-white outline-none transition-all duration-300 focus:border-[#C2DFE3] focus:bg-black/50 focus:ring-0 rounded-t-xl cursor-pointer"
                    >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full border-0 border-b-2 border-white/30 bg-black/30 backdrop-blur-md px-3 py-3 pl-10 text-sm text-white placeholder-gray-400 outline-none transition-all duration-300 focus:border-[#C2DFE3] focus:bg-black/50 focus:ring-0 rounded-t-xl"
                      />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border-0 border-b-2 border-white/30 bg-black/30 backdrop-blur-md px-3 py-3 text-sm text-white placeholder-gray-400 outline-none transition-all duration-300 focus:border-[#C2DFE3] focus:bg-black/50 focus:ring-0 rounded-t-xl"
                      />
                      {errors.patientAge && (
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full border-0 border-b-2 border-white/30 bg-black/30 backdrop-blur-md px-3 py-3 text-sm text-white outline-none transition-all duration-300 focus:border-[#C2DFE3] focus:bg-black/50 focus:ring-0 rounded-t-xl cursor-pointer"
                      >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border-0 border-b-2 border-white/30 bg-black/30 backdrop-blur-md px-4 py-3 text-sm text-white outline-none transition-all duration-300 focus:border-[#C2DFE3] focus:bg-black/50 focus:ring-0 rounded-t-xl"
                  />
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full border-0 border-b-2 border-white/30 bg-black/30 backdrop-blur-md p-4 pl-10 text-sm text-white placeholder-gray-400 outline-none transition-all duration-300 focus:border-[#C2DFE3] focus:bg-black/50 focus:ring-0 rounded-t-xl font-jakarta"
                    />
