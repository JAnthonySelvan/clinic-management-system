    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto font-outfit">
          ...
          {/* Modal Card Container with reduced rounded radius (rounded-2xl) */}
          <motion.div
            initial={{ opacity: 0, scale: 0.96, y: 15 }}
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.96, y: 15 }}
            transition={{ duration: 0.25, ease: "easeOut" }}
            className="relative w-full max-w-5xl my-6 overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-slate-900/10 z-10 max-h-[90vh] flex flex-col border border-gray-100"
          >
            {/* Header Banner with Dark Luxury Gradient & Ambient Teal Glow */}
            <div className="relative overflow-hidden p-6 sm:p-7 text-white shrink-0 bg-gradient-to-r from-[#060c0f] via-[#0f1d24] to-[#060c0f] border-b border-teal-500/20">
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-5">
                ...
                <div className="text-center sm:text-left">
                  <div className="inline-flex items-center space-x-1.5 rounded-full bg-white/10 px-3 py-1 text-xs font-normal text-teal-200 border border-white/15 backdrop-blur-md mb-2">
                    <Stethoscope className="h-3.5 w-3.5 text-teal-300" />
                    <span className="font-jakarta font-medium tracking-wide">{activeDoctor?.specialization || "General Healthcare"}</span>
                  </div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-300 font-light font-jakarta mt-1">
            ...
            {/* Scrollable Form Body with FORMS_IMAGE.BookingModal Background & Dark Glass Scrim */}
            <div className="relative p-6 sm:p-8 overflow-y-auto text-white bg-[#060c0f]">
              <img
                src={FORMS_IMAGE.BookingModal}
                alt="Form Body Background"
                aria-hidden="true"
              ...
              <div className="relative z-10 space-y-6">
                ...
                {availableDoctors && availableDoctors.length > 0 && (
                  <div className="rounded-2xl bg-white/5 p-4 border border-teal-400/20 backdrop-blur-md">
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-teal-400/30 bg-[#0d181d] px-4 py-3 text-sm font-medium text-white outline-none shadow-2xs transition focus:border-teal-400 focus:ring-2 focus:ring-teal-400/20 cursor-pointer"
                    >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  <h3 className="text-xs font-medium uppercase tracking-wider text-teal-300 mb-4 flex items-center space-x-1.5 font-jakarta">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full rounded-xl border border-white/20 bg-[#13222a] px-4 py-3 pl-10 text-sm text-white placeholder-gray-400 outline-none transition focus:border-teal-400 focus:bg-[#182a34] focus:ring-2 focus:ring-teal-400/20"
                        />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-white/20 bg-[#13222a] px-4 py-3 text-sm text-white placeholder-gray-400 outline-none transition focus:border-teal-400 focus:bg-[#182a34] focus:ring-2 focus:ring-teal-400/20"
                        />
                        {errors.patientAge && (
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full rounded-xl border border-white/20 bg-[#13222a] px-3 py-3 text-sm text-white outline-none transition focus:border-teal-400 focus:bg-[#182a34] focus:ring-2 focus:ring-teal-400/20 cursor-pointer"
                        >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-white/20 bg-[#13222a] px-4 py-3 text-sm text-white outline-none transition focus:border-teal-400 focus:bg-[#182a34] focus:ring-2 focus:ring-teal-400/20"
                      />
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full rounded-xl border border-white/20 bg-[#13222a] p-4 pl-10 text-sm text-white placeholder-gray-400 outline-none transition focus:border-teal-400 focus:bg-[#182a34] focus:ring-2 focus:ring-teal-400/20 font-jakarta"
                    />
                    <FileText className="absolute left-3.5 top-3.5 h-4 w-4 text-teal-400" />
                  </div>
                  {errors.reason && (
                ...
                <div className="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 border-t border-white/10 pt-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full sm:w-auto flex items-center justify-center space-x-2 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-600 px-8 py-3.5 text-sm font-medium text-white shadow-lg shadow-teal-950/40 hover:from-teal-500 hover:to-emerald-500 hover:scale-[1.02] disabled:opacity-70 transition cursor-pointer"
                  >
                    {loading ? (
                      <>
