  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden min-h-[60vh] flex items-center justify-center py-24 lg:py-32 bg-[#080e12]">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-2 text-xs sm:text-sm font-normal tracking-wide text-teal-200 backdrop-blur-md shadow-2xl">
            <Stethoscope className="h-4 w-4 text-teal-300" />
            <span className="font-jakarta font-medium tracking-wide">Clinical Faculty & Specialists</span>
          </span>
          ...
          <p className="mx-auto max-w-2xl text-base sm:text-lg lg:text-xl font-light text-gray-300 leading-relaxed font-jakarta">
            Our team of highly qualified specialists is dedicated to providing compassionate, evidence-based, and advanced healthcare.
          </p>
        </AnimatedSection>
      </section>
