...
const VisionMission = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ["mission-vision", "story", "core-values", "director-quote", "patient-promises", "stats"];
        ...
        <nav className="sticky top-16 z-30 bg-white/90 backdrop-blur-md border-b border-gray-200/80 shadow-xs py-3 transition-all duration-300">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-1 text-xs sm:text-sm font-semibold">
              ...
              <a
                href="#core-values"
                onClick={(e) => scrollToSection(e, "core-values")}
                className={`flex items-center gap-2 rounded-xl px-3.5 py-2 transition-all cursor-pointer whitespace-nowrap ${
              ...
              <a
                href="#director-quote"
                onClick={(e) => scrollToSection(e, "director-quote")}
                className={`flex items-center gap-2 rounded-xl px-3.5 py-2 transition-all cursor-pointer whitespace-nowrap ${
                  activeSection === "director-quote"
                    ? "bg-[#253237] text-white shadow-md"
                    : "text-[#5C6B73] hover:bg-[#F8FBFC] hover:text-[#253237]"
                }`}
              >
              ...
              <a
                ...
                onClick={(e) => scrollToSection(e, "patient-promises")}
                className={`flex items-center gap-2 rounded-xl px-3.5 py-2 transition-all cursor-pointer whitespace-nowrap ${
                  activeSection === "patient-promises"
                    ? "bg-[#253237] text-white shadow-md"
                    : "text-[#5C6B73] hover:bg-[#F8FBFC] hover:text-[#253237]"
                }`}
              >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 space-y-24">
            ...
            <div className="grid gap-8 md:grid-cols-2 w-full">
              ...
              >
                <div>
                  ...
                  <div className="relative h-64 w-full overflow-hidden bg-[#253237] [clip-path:polygon(0_0,_100%_0,_100%_88%,_0_100%)]">
                    <img
          ...
          <section id="story" className="scroll-mt-32">
            <div className="rounded-4xl bg-white p-8 sm:p-12 shadow-xl border border-gray-100">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 relative w-full">
          ...
          <section id="director-quote" className="scroll-mt-32">
            <AnimatedSection
              direction="up"
          ...
          {/* ================= SECTION 5: PATIENT PROMISES ================= */}
          <section id="patient-promises" className="scroll-mt-32">
            <AnimatedSection
              direction="up"
